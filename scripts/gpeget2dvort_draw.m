function [xlocs,ylocs,pol] = gpeget2dvort_draw(dens,ophase,gridx,gridy,potential)

disp(['Grid spacing is ',num2str(gridx(2)-gridx(1)),'.']);
gf = 0.5; %Gaussian filter width. Should really be about the size of a vortex core
...
th = 2; %threshold value. I have set it to just over pi/2.
