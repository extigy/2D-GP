function [xlocs,ylocs,pol] = gpeget2dvort_fl(dens,ophase,gridx,gridy,potential)

disp(['Grid spacing is ',num2str(gridx(2)-gridx(1)),'.']);

gf = 2; %Gaussian filter width. Should really be about the size of a 50% vortex core in your units
...
th = 3.0; %threshold value. I have set it to just over pi/2.
